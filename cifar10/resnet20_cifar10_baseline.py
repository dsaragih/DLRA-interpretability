...
from models_folder.resnet20_baseline import ResNet20
import torch
...
def parse_args():
    ...
    parser.add_argument('--net_name', type=str, default='resnet20_cifar10_baseline', metavar='NET_NAME',
...
def main():
    ...
    #dlr_opt(NN, tau=args.lr, theta=args.theta,KLS_optim = torch.optim.SGD,momentum = args.momentum)
